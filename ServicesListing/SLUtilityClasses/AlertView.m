...
-(void)displayInformativeAlertwithTitle:(NSString *)title andMessage:(NSString*)message onController:(UIViewController*)controller {
    ...
    [self presentAlertWithTitle:title message:message andButtonsWithTitle:[NSArray arrayWithObject:SLLocalizedString(@"OK")] onController:controller dismissedWith:^(NSInteger index, NSString *buttonTitle) { }];
}
